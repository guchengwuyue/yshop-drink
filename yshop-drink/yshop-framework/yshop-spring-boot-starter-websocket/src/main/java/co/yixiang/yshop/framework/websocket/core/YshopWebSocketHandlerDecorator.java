package co.yixiang.yshop.framework.websocket.core;
...
public class YshopWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public YshopWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
