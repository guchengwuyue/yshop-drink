...
public class CodeGenerator {
    ...
    private static final String DRIVER_URL = "jdbc:mysql://127.0.0.1:3306/supply-shop?autoReconnect=true&useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8";

    private static final String PARENT_PACKAGE = "co.yixiang.app";
    ...
    private static final String PROJECT_PACKAGE_PATH = "co/yixiang/app";


    // ############################ 配置部分 start ############################
    // 模块名称
    private static final String MODULE_NAME = "distribution";
    // 作者
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/supplier-api/src/main/java");
        gc.setAuthor(AUTHOR);
        ...
        pc.setParent("co.yixiang.app.modular");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/supplier-api/src/main/resources/mapper/" + pc.getModuleName()
        ...
        focList.add(new FileOutConfig("/templates/queryParam.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/supplier-api/src/main/java/"+ PROJECT_PACKAGE_PATH +"/modular/" + pc.getModuleName() + "/web/param/" + tableInfo.getEntityName() + "QueryParam" + StringPool.DOT_JAVA;
            }
        });
        ...
        focList.add(new FileOutConfig("/templates/queryVo.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/supplier-api/src/main/java/"+ PROJECT_PACKAGE_PATH +"/modular/" + pc.getModuleName() + "/web/vo/" + tableInfo.getEntityName() + "QueryVo" + StringPool.DOT_JAVA;
            }
        });
