...
import co.yixiang.app.common.exception.EntityExistException;
import co.yixiang.app.common.persistence.dao.StoreCartMapper;
import co.yixiang.app.common.persistence.dao.StoreGoodsCollectMapper;
import co.yixiang.app.common.persistence.dao.StoreGoodsMapper;
import co.yixiang.app.common.persistence.dao.StoreSpecGoodsPriceMapper;
import co.yixiang.app.common.persistence.model.StoreCart;
import co.yixiang.app.common.persistence.model.StoreGoods;
import co.yixiang.app.common.persistence.model.StoreGoodsCollect;
...
import co.yixiang.app.modular.shop.service.vo.CartAttrVO;
...
import co.yixiang.app.common.exception.BadRequestException;
import co.yixiang.app.common.exception.EntityExistException;
import co.yixiang.app.common.persistence.dao.StoreCartMapper;
import co.yixiang.app.common.persistence.dao.StoreGoodsCollectMapper;
import co.yixiang.app.common.persistence.dao.StoreGoodsMapper;
...
import co.yixiang.app.modular.shop.service.dto.ItemDTO;
import co.yixiang.app.modular.shop.service.dto.SpecItemDTO;
import co.yixiang.app.modular.shop.service.mapper.CartMapper;
...
public class GoodsServiceImpl extends ServiceImpl<StoreGoodsMapper, StoreGoods>  implements IGoodsService {
    ...
    public Map<String, List<SpecItemDTO>> goodsSpec(int goodsId){
        ...
        if(StrUtil.isEmpty(keys)){
            throw new BadRequestException("商品规格未添加");
        }
    ...
    public boolean addOrCancelCollect(int goodsId, int userId, int type) {
        if(type == 1){//1-添加 2-取消
            ...
            if(isCollect)  throw new BadRequestException("已经收藏过");
