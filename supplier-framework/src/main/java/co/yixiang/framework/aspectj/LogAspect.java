package co.yixiang.framework.aspectj;
...
import co.yixiang.common.enums.BusinessStatus;
import co.yixiang.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(co.yixiang.common.annotation.Log)")
